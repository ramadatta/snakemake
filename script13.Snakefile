...
rule prokka:
     input: 'SPAdes_Assemblies/gteq1kb/{sample}.gte1kb.contigs.fasta'
     output: 
         o=directory('Prokka/{sample}_prokka_out')
     shell: 
        'prokka --force --cpus 32 --outdir {output.o} --prefix {wildcards.sample} {input} >>{wildcards.sample}.prokka_log 2>>{wildcards.sample}.prokka_error'
