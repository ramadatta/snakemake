...
rule all:
    input:
        expand('SPAdes_Assemblies/gteq1kb/{sample}.gte1kb.contigs.fasta', sample=SAMPLES), 'mlst/Combined_log_mlst_2.19.txt'
"""
...
rule kraken2:
    input:
        ...
        r2 = '{sample}_2.fastq'
     output: 
	result = 'Kraken2/{sample}_kraken2_result'
	report = 'Kraken2/{sample}_kraken2_report'	
     shell: 
